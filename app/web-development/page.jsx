    ...
    <div className={styles.container}>
        ...
        <div className={styles.gitContainer}>
          ...
          >
            ...
            <p>
              ...
              application from new installs or API service. Seamless integration
      ...
      <section className={styles.projectsSection}>
        <div className={styles.sectionHeader}>
          ...
          <p>Real projects generating revenue and solving business problems</p>
        </div>
      ...
      <section className={styles.finalCTA}>
        ...
        >
          ...
          <p>
            Join thousands of developers who trust our platform to build amazing
            software
          </p>
          <Link href="/register">
            {" "}
