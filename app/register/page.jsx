  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <div className={`${styles.registerCard} ${isVisible ? styles.cardVisible : ""}`}>
          <div className={styles.header}>
            <div className={styles.logo}>
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                <circle cx="20" cy="20" r="20" fill="#6366F1" />
                <path d="M25 15L17 23L15 21" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.checkboxGroup}>
              <label className={styles.checkboxLabel}>
                <input type="checkbox" name="acceptTerms" checked={form.acceptTerms} onChange={handleInputChange} className={styles.checkbox}/>
                <span className={styles.checkboxCustom}></span>I agree to the <a href="#" className={styles.termsLink}>Terms and Conditions</a>
              </label>
              {errors.acceptTerms && <span className={styles.errorText}>{errors.acceptTerms}</span>}
            </div>

            {/* Submit */}
            <button type="submit" className={`${styles.button} ${isLoading ? styles.buttonLoading : ""}`} disabled={isLoading}>
